    ...
    <div class="row align-items-md-stretch">
      ...
      <div class="col-md-12">
        <div class="h-100 p-5 text-bg-dark rounded-3 ">
          <center><h1>Editar Categorias</h1> <i class="fa-solid fa-boxes-stacked fa-2xl"></i></center>
        </div>
      </div>
        ...
        <form role="form "action="<?= PATH ?>/Categorias/update" method="POST">
            ...
            <div class="form-group col-md-6 m-3">
                ...
                <div class="input-group my-2">
                    ...
                    <input type="text" class="form-control" readonly="true" name="ID_Categoria" id="ID_Categoria" placeholder="Ingresa la Categoria" value="<?= isset($categoria)?$categoria['ID_Categoria']:'' ?>" >
                </div>
            </div>
            ...
            <div class="form-group col-md-6 m-3">
                ...
                <div class="input-group my-2">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-star-of-life"></i></span>
                    <input type="text" class="form-control" name="Categoria" id="Categoria" placeholder="Ingresa la Categoria" value="<?= isset($categoria)?$categoria['Categoria']:'' ?>" >
                </div>
            </div>
