      ...
      <div class="col-md-12">
        <div class="h-100 p-5 text-bg-dark rounded-3 ">
          <center>
            ...
            <p>Bienvenido, se encuentra en la interfaz administrativa de la tienda, podra en este apartado actualizar, agregar y eliminar las categorias de productos</p>
          </center>
          <div class="d-flex justify-content-around">
            <a type="button" class="btn btn-light" href="<?=PATH?>/Categorias/create"><i class="fa-solid fa-plus fa-lg"></i>  Agregar Categoria</a>
            <a type="button" class="btn btn-light" href="<?=PATH?>/Productos/Admin"><i class="fa-solid fa-rotate-left fa-lg"></i>  Regresar</a>
        ...
        <table class="table table-striped table-bordered table-hover table-responsive table-condensed" id="tabla" style="margin-top:20px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a type="button" class="btn btn-primary" href="<?= PATH.'/Categorias/edit/'.$categoria['ID_Categoria']?>"><i class="fa-solid fa-pen-to-square"></i> Editar</a>
                          <a type="button" class="btn btn-danger" href="<?= PATH ?>/Categorias/remove/<?= $categoria['ID_Categoria'] ?>"><i class="fa-solid fa-delete-left"></i> Eliminar</button>                    
                        </td>
                    </tr>
                    <?php          
                    }
