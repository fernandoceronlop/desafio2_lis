      ...
      <div class="col-md-12">
        <div class="h-100 p-5 text-bg-dark rounded-3 ">
          <center>
            ...
            <p>Bienvenido, se encuentra en la interfaz administrativa de la tienda, podra en este apartado actualizar, agregar e inhabilitar los usuarios de la tienda.</p>
          </center>
          <div class="d-flex justify-content-around">
            <a type="button" class="btn btn-light" href="<?=PATH?>/Usuarios/create"><i class="fa-solid fa-plus fa-lg"></i>  Agregar Usuario</a>
        ...
        <table class="table table-striped table-bordered table-hover table-responsive table-condensed" id="tabla" style="margin-top:20px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a type="button" class="btn btn-primary" href="<?= PATH.'/Usuarios/edit/'.$usuario['ID_Usuario']?>"><i class="fa-solid fa-pen-to-square"></i> Editar</a>                   
                        </td>
                    </tr>
                    <?php          
                    }
