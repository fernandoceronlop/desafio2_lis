...
$pdf->Cell(80, 10, utf8_decode($product2["Nombre"]), 1, 0, 'C', 0);
...
$pdf->Output('F', '/Desafio2_MVC/MVC-main/View/PDF/Prueba.pdf'/*'Prueba.pdf', 'I'*/);//nombreDescarga, Visor(I->visualizar - D->descargar)
