    ...
    <div class="modal-content">
      ...
      <div class="modal-body form">
        <ul class="list-group">
          ...
          <li class="list-group-item"> <b>Codigo: </b> <span id="codigo"></span></li>
          <li class="list-group-item"> <b>Categoria: </b> <span id="categoria"></span></li>
          ...
          <div class="card p-1 my-3">
            <div class="card-body">
              <b>Descripcion:</b> <span id="descripcion"></span>  
            </div>
          </div>
        </ul>
      </div>
