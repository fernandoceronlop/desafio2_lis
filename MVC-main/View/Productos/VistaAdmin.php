    ...
    <div class="row align-items-md-stretch">
      ...
      <div class="col-md-12">
        <div class="h-100 p-5 text-bg-dark rounded-3 ">
          ...
          <div class="d-flex justify-content-around">
            <a type="button" class="btn btn-light" href="<?=PATH?>/Productos/create"><i class="fa-solid fa-plus fa-lg"></i>  Agregar Producto</a>
            <a type="button" class="btn btn-light" href="<?=PATH?>/Categorias/index"><i class="fa-solid fa-pen-to-square fa-lg"></i>  Administrar Categorias</a>
            <a type="button" class="btn btn-light" href="<?=PATH?>/Usuarios/index"><i class="fa-solid fa-user-pen fa-lg"></i>  Detalle de Usuarios</a>
            <a type="button" class="btn btn-light" href="<?=PATH?>/Productos/Detalles"><i class="fa-solid fa-chart-column fa-lg"></i>  Detalle de Ventas</a>
          </div>
        </div>
      </div>
        ...
        <table class="table table-striped table-bordered table-hover table-responsive table-condensed" id="tabla" style="margin-top:20px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal" href="javascript:void(0)" onclick="detalles('<?=$producto['ID_Producto']?>')"><i class="fa-regular fa-eye"></i> Ver</a>
                          <a type="button" class="btn btn-primary" href="<?= PATH.'/Productos/edit/'.$producto['ID_Producto']?>"><i class="fa-solid fa-pen-to-square"></i> Editar</a>
                          <a type="button" class="btn btn-danger" href="<?= PATH ?>/Productos/remove/<?= $producto['ID_Producto'] ?>"><i class="fa-solid fa-delete-left"></i> Eliminar</a>                    
                        </td>
                    </tr>
                    <?php          
                    }
