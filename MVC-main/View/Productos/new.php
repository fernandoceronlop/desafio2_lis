...
<main>
  <div class="container py-4">
    ...
    <div class="row align-items-md-stretch">
      ...
      <div class="col-md-12">
        <div class="h-100 p-5 text-bg-dark rounded-3 ">
          <center><h1>Nuevos Productos</h1> <i class="fa-solid fa-boxes-stacked fa-2xl"></i></center>
        </div>
      </div>
    ...
    <div class="row align-items-md-stretchS py-4">
        ...
        <form role="form "action="<?= PATH ?>/Productos/add" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    ...
                    <input type="text" class="form-control" name="ID_Producto" id="ID_Producto" placeholder="Ingresa el Codigo del producto" value="<?= isset($productos)?$productos['ID_Producto']:'' ?>" >
                </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-star-of-life"></i></span>
                    <input type="text" class="form-control" name="Nombre" id="Nombre" placeholder="Ingresa el Nombre del producto" value="<?= isset($productos)?$productos['Nombre']:'' ?>" >
                </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-star-of-life"></i></span>
                    <input type="text" class="form-control" name="Descripcion" id="Descripcion" value="<?= isset($productos)?$productos['Descripcion']:'' ?>" ></input>
                </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    ...
                    <input type="number" class="form-control" name="Precio" id="Precio" placeholder="Ingresa el Precio del producto" step="0.01" min="0" value="<?= isset($productos)?$productos['Precio']:'' ?>" >
                </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-star-of-life"></i></span>
                    <input type="number" class="form-control" name="Existencias" id="Existencias" placeholder="Ingresa las existencias del producto" min="0" value="<?= isset($productos)?$productos['Existencias']:'' ?>" >
                </div>
            </div>
